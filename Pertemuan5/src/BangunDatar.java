...
public abstract class BangunDatar {
    ...
    /*------------------LAINNYA-------------------*/
    // metode abstract untuk mengembalikan luas bangun datar
    public abstract double getLuas();

    // metode abstract untuk mengembalikan keliling bangun datar
    public abstract double getKeliling();

    // memeriksa apakah luas dari dua bangun datar adalah sama
    public boolean isEqualLuas(BangunDatar X){
        return this.getLuas() == X.getLuas();
    }

    // memeriksa apakah keliling dari dua bangun datar adalah sama
